...
document.addEventListener("DOMContentLoaded", function() {
    {
        ...
        b && b.addEventListener("click", e=>{
                i.forEach(e=>{
                    ...
                    g.indeterminate = !1,
                    g.checked = !1,
                0 == document.querySelectorAll(".email-list-item").length && L.classList.remove("d-none")
            }
        ),
        ...
        C && C.forEach(e=>{
                e.addEventListener("click", e=>{
                        ...
                        0 == document.querySelectorAll(".email-list-item").length && L.classList.remove("d-none")) : Helpers._hasClass("email-read", e) ? (e.parentNode.closest("li.email-list-item").classList.add("email-marked-read"),
